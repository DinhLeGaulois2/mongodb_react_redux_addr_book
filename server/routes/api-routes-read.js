...
module.exports = function (app) {
    ...
    app.get("/api/get/contact/:id", (req, res, next) => {
        Contacts.find({ _id: req.params.id }).then(data => res.status(200).json(data))
            .catch(next)
    })
    ...
    app.get("/api/get/phone/contact/:id", (req, res, next) => {
        Contacts.find({ _id: req.params.id }).then(data =>
            Phones.find({ contactId: data._id }).then(data => {
    ...
    app.get("/api/get/addresse/contact/:id", (req, res, next) => {
        Contacts.find({ _id: req.params.id }).then(data =>
            Addresses.find({ contactId: data._id }).then(data => {
                res.status(200).json(data)
            })
                .catch(next)
        )
    ...
    app.get("/api/get/group/contact/:id", (req, res, next) => {
        Contacts.find({ _id: req.params.id }).then(data =>
            Groups.find({ contactId: data._id }).then(data => {
                res.status(200).json(data)
            })
                .catch(next)
        )
    ...
    app.get("/api/get/twitter/contact/:id", (req, res, next) => {
        Contacts.find({ _id: req.params.id }).then(data =>
            Twitter.find({ contactId: data._id }).then(data => {
                res.status(200).json(data)
            })
                .catch(next)
        )
    ...
    app.get("/api/get/thumbnail/contact/:id", (req, res, next) => {
        Contacts.find({ _id: req.params.id }).then(data =>
            Thumbnails.find({ contactId: data._id }).then(data => {
                res.status(200).json(data)
            })
                .catch(next)
        )
    ...
    app.get("/api/get/portrait/contact/:id", (req, res, next) => {
        Contacts.find({ _id: req.params.id }).then(data =>
            Portraits.find({ contactId: data._id }).then(data => {
                res.status(200).json(data)
            })
                .catch(next)
        )
